...
contract ForeverLibraryV3 is ERC1155, ERC2981, ReentrancyGuard, Multicall {
    ...
    constructor() ERC1155("") {
        ...
        // RESOLVED (open work 4): the V1 mark on Ethereum-roundel blue
        // #627EEA. Per-chain deployments swap this constant (per-chain
        // icon colors are the V2 convention); see deploy preflight.
